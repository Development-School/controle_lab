	...
	<nav class="navbar navbar-default">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<li <?php if($ativo == 4){echo 'class="active"';}?>><a href="<?php echo base_url('aula');?>"><i class="fa fa-book fa-fw fa-lg"></i>&nbsp;Aulas</a></li>
				<li <?php if($ativo == 6){echo 'class="active"';}?>><a href="<?php echo base_url('ajuda');?>"><i class="fa fa-question fa-fw fa-lg"></i>&nbsp;Ajuda</a></li>
				<li class="dropdown">

...
        $.getJSON( '<?php echo site_url("admin2/Reserva_lab/getDisciplina") ?>/' + curso, function (data){ 
...
<body>
  ...
  $dados['ativo'] = 3; $this->load->view('admin2/navbar',$dados);?>
  <div class="row">
  <div class="col-sm-12">    
    <?php 
    echo form_open('admin2/Reserva_lab/receber','class="form-horizontal"'); 

<!--Barra de Navegação -->
<h4 class="text-right text-capitalize">Olá Professor, <?php echo strtolower($this->session->nome);?></h4>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<a class="navbar-brand" style="font-size: 14px;" href="<?php echo base_url('admin2/paineladm');?>">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				<li <?php if($ativo == 1){echo 'class="active"';}?>><a href="<?php echo base_url('admin2/paineladm');?>"><i class="fa fa-home fa-fw fa-lg hidden-sm"></i>&nbsp;Início</a></li>
				<li <?php if($ativo == 2){echo 'class="active"';}?>><a href="<?php echo base_url('admin2/Labs');?>"><i class="fa fa-flask fa-fw fa-lg hidden-sm"></i>&nbsp;Laboratorios</a></li>

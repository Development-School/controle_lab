<!--Barra de Navegação -->
<h4 class="text-right text-capitalize">Olá Técnico, <?php echo strtolower($this->session->nome);?></h4>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<a class="navbar-brand" style="font-size: 14px;" href="<?php echo base_url('admin3/paineladm');?>">
